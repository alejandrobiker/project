		                        ...
		                        <div class="form-group">
                        			<div class="input-group">
                     				 	...
                     				 	<select style="height:40px" name="rol" class="form-control" required/>
                        					...
                        					<option value="Manager Vencert">Manager Vencert</option>

                        					<option value="Manager Cenif">Manager Cenif</option> 

                        					<option value="Manager Administracion">Manager Administracion</option> 

                        					<option value="Manager P O P">Manager Planificacion, Organizacion y Presupuesto</option>

                       						<option value="Manager Asesoria Legal">Manager Asesoria Legal</option>

                        					<option value="Manager Recursos Humanos">Manager Recursos Humanos</option> 
                        
                    						<option value="Manager Area Tecnica">Manager Área Técnica</option>
                        
                 							<option value="Manager Formacion presencial en Linea">Manager Formacion presencial en Línea</option>
                        				</select>
                   				 	</div>
           					    </div>
