           				 ...
           				 <?php 
           				 	session_start(); 
           				 		...
           				 		echo'
  				 					...
  				 					echo'<button class="btn btn-primary sesion dropdown-toggle" type="button" data-toggle="dropdown"> '.$_SESSION['usernombre'].' '.$_SESSION['userapellido'].'  '.'<span class="caret"></button>
