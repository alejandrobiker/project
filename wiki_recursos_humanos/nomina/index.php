			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Nomina.php");						
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_nom");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_recursos_humanos/nomina/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_nom");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_recursos_humanos/nomina/index.php');
						</script>
