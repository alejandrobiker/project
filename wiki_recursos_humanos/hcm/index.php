				...
				<!-- Contenido del link 10 columnas-->				
					<div class="col-md-10">
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_hcm");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_recursos_humanos/hcm/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_hcm");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_recursos_humanos/hcm/index.php');
						</script>
