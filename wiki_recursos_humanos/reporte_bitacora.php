...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Bitácora Recursos Humanos</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM bitacora WHERE TABLA LIKE 'hcm_articulo_t' OR TABLA LIKE 'hcm_articulo_d' OR TABLA LIKE 'hcm_manual' OR TABLA LIKE 'hcm_tutorial' OR TABLA LIKE 'nomina_articulo_d' OR TABLA LIKE 'nomina_articulo_t' OR TABLA LIKE 'nomina_manual' OR TABLA LIKE 'nomina_tutorial' ORDER BY ID_BITACORA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_bitacora_Recursos_Humanos.pdf");
