...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Usuarios</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM usuarios_wiki ORDER BY CEDULA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_usuarios.pdf");
