...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Bitácora</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM bitacora ORDER BY ID_BITACORA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_bitacora.pdf");
