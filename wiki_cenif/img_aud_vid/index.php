	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
							...
							include("utilidad/php/Img_Aud_Vid.php");						
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Imágenes, Audio y Video</h2>
				...
				<div class="col-md-10">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Artículo</li>							      
								...
								session_start();
						                	...
						                	if ($_SESSION['usercedula'] != null && $_SESSION['userrol'] == "Manager Cenif" || $_SESSION['userrol'] == "Usuario Img, Audio y Video") {				      echo'
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_iva");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_cenif/img_aud_vid/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_iva");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_cenif/img_aud_vid/index.php');
						</script>
