	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Fuentes_Abiertas.php");
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Fuentes Abiertas</h2>
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<ul class="breadcrumb">
							...
							<li class="active">Artículo</li>							      
						      ...
						      if ($_SESSION['usercedula'] != null && $_SESSION['userrol'] == "Manager Cenif" || $_SESSION['userrol'] == "Usuario Fuentes Abiertas") {					      echo'
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_fa");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_cenif/fuentes_abiertas/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_fa");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_cenif/fuentes_abiertas/index.php');
						</script>
