	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Dispositivos_Almacenamiento.php");						
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Dispositivos de Almacenamiento</h2>
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<ul class="breadcrumb">
							...
							<li class="active">Artículo</li>							      
								...
								session_start();
						                	...
						                	if ($_SESSION['usercedula'] != null && $_SESSION['userrol'] == "Manager Cenif" || $_SESSION['userrol'] == "Usuario Dispositivos Almacenamiento") {				      echo'
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_da");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_cenif/dispositivos_almacenamiento/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_da");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_cenif/dispositivos_almacenamiento/index.php');
						</script>
