...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Bitácora Cenif</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM bitacora WHERE TABLA LIKE 'uaf_fuentes_abiertas_articulo_t' OR TABLA LIKE 'uaf_fuentes_abiertas_articulo_d' OR TABLA LIKE 'uaf_fuentes_abiertas_manual' OR TABLA LIKE 'uaf_fuentes_abiertas_tutorial' OR TABLA LIKE 'uaf_equipos_moviles_articulo_t' OR TABLA LIKE 'uaf_equipos_moviles_articulo_d' OR TABLA LIKE 'uaf_equipos_moviles_manual' OR TABLA LIKE 'uaf_equipos_moviles_tutorial' OR TABLA LIKE 'uaf_dispositivo_almacenamiento_articulo_t' OR TABLA LIKE 'uaf_dispositivo_almacenamiento_articulo_d' OR TABLA LIKE 'uaf_dispositivo_almacenamiento_manual' OR TABLA LIKE 'uaf_dispositivo_almacenamiento_tutorial' OR TABLA LIKE 'uaf_electronica_articulo_t' OR TABLA LIKE 'uaf_electronica_articulo_d' OR TABLA LIKE 'uaf_electronica_manual' OR TABLA LIKE 'uaf_electronica_tutorial' OR TABLA LIKE 'uaf_imagen_video_audio_articulo_t' OR TABLA LIKE 'uaf_imagen_video_audio_articulo_d' OR TABLA LIKE 'uaf_imagen_video_audio_manual' OR TABLA LIKE 'uaf_imagen_video_audio_tutorial' ORDER BY ID_BITACORA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_bitacora_Cenif.pdf");
