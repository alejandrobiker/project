		                        ...
		                        <div class="form-group">
                        			<div class="input-group">
                     				 	...
                     				 	<select style="height:40px" name="rol" class="form-control" required/>
                        					...
                        					<option value="Usuario Fuentes Abiertas">Usuario Fuentes Abiertas</option>
                        					<option value="Usuario Equipos Moviles">Usuario Equipos Moviles</option>
                        					<option value="Usuario Dispositivos Almacenamiento">Usuario Dispositivos Almacenamiento</option>
                        					<option value="Usuario Electronica">Usuario Electrónica</option>
                        					<option value="Usuario Img, Audio y Video">Usuario Img, Audio y Video</option>
                        				</select>
                   				 	</div>
           					    </div>
