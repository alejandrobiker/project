...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Usuarios Cenif</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM usuarios_wiki WHERE ROL LIKE 'Usuario Fuentes Abiertas' OR ROL LIKE 'Usuario Equipos Moviles' OR ROL LIKE 'Usuario Dispositivos Almacenamiento' OR ROL LIKE 'Usuario Electronica' OR ROL LIKE 'Usuario Img, Audio y Video' ORDER BY CEDULA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_usuarios_Cenif.pdf");
