				...
				<!-- Contenido del link 10 columnas-->				
					<div class="col-md-10">
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_em");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_cenif/equipos_moviles/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_em");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_cenif/equipos_moviles/index.php');
						</script>
