...
<body>
	        ...
	        <div class="modal-dialog">
	          	<div class="modal-content">
		            ...
		            <div class="modal-body">       
	     				...
	     				<form action="javascript:em_registrar();" name="frm_em_registrar" enctype="multipart/form-data" id="uaf_em_registrar">
		                        		                      
			                <div class="form-group">
		                        <div class="input-group">
		                        	<span class="input-group-addon">Título</span>
		                        	<input type="text" name="em_titulo" class="form-control" required onkeypress="return solomayuscula(event,this)">
		                       		
		                       		<span class="input-group-addon">Tipo de Contenido</span>
								 	<select name="em_tipo" class="form-control" required/>
			                ...
			                <div class="form-group">
			                    <div class="input-group">
			                        ...
			                        <textarea name="em_descripcion" class="form-control" cols="60" rows="4" required onkeypress="return solomayuscula(event,this)"></textarea>
								</div>
		                    </div>
			                    <div class="alert alert-success" role="alert" id="mos_em" hidden></div>	          
	...
	<script type="text/javascript">
		...
		editorwiki = CKEDITOR.replace("em_descripcion");
		CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_cenif/equipos_moviles/index.php')
		 //}
	</script>
	        ...
	        <div class="modal-dialog">
	          	<div class="modal-content">
		            ...
		            <div class="modal-body">       
	     				...
	     				<form action="javascript:em_manual();" name="frm_rwiki" enctype="multipart/form-data" id="em_manual">
		                        		                      
			                <div class="form-group">
		                        <div class="input-group">
		                        	<span class="input-group-addon">Título</span>
		                        	<input type="text" name="em_manual_titulo" class="form-control" required onkeypress="return solomayuscula(event,this)">

		                        	<span class="input-group-addon">Tipo de Contenido</span>
								 	<select name="em_manual_tipo" class="form-control" required/>
										<option value="publico">Público</option>
										<option value="privado">Privado</option>
									</select>
		                        </div>
			                ...
			                <div class="form-group">
			                	...
			                	<div id="agarrarimagen">
		                    		<input name="file_em_manual" type="file" class="file" id="files" accept="image/docx" multiple required  onchange="return documentos(this)"/>
	                 			</div>
	        ...
	        <div class="modal-dialog">
	          	<div class="modal-content">
		            ...
		            <div class="modal-body">       
	     				...
	     				<form action="javascript:em_tutorial();" name="frm_rwiki" enctype="multipart/form-data" id="em_tutoriales">
		                        		                      
			                <div class="form-group">
		                        <div class="input-group">
		                        	<span class="input-group-addon">Título</span>
		                        	<input type="text" name="em_tutorial_titulo" class="form-control" required onkeypress="return solomayuscula(event,this)">

		                        	<span class="input-group-addon">Tipo de Contenido</span>
								 	<select name="em_tutorial_tipo" class="form-control" required/>
										<option value="publico">Público</option>
										<option value="privado">Privado</option>
									</select>
		                        </div>
			                ...
			                <div class="form-group">
		                		...
		                		<div id="agarrarimagen">
	                    			<input name="file_em_tutorial" class="file" type="file" id="filestuto" accept="video/mp4" multiple required  onchange="return videos(this)"/>
	                 		 	</div>
	                			...
	                			<div class="alert alert-success" role="alert" id="res_em_tutoriales" hidden></div>	                  
