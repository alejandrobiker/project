				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM dictamenes_articulo_t WHERE ID_DAT = '$_POST[ideliminar_dic_titulo]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									...
									<div class="alert alert-danger" role="alert" id="mos_dic_titulo" hidden></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:dic_eliminar_titulo();" name="frm_diceliminar_titulo">

										<input type="text" name="ideliminar_dic_titulo" value="'.$reg['ID_DAT'].'" hidden>
										<input class="btn btn-danger pulse-grow" type="submit" id="diceliminar_titulo" value="Eliminar" data-toggle="tooltip" data-placement="top" title="Eliminar">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM dictamenes_articulo_d WHERE ID_DAD = '$_POST[ideliminar_dic_descripcion]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									<h2>'.$reg['DESCRIPCION_DAD'].'</h2>								

									<div class="alert alert-danger"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
									¿Estas seguro que desea eliminar esta descripción?
									</div>

									<div class="alert alert-danger" role="alert" id="mos_dic_descripcion" hidden></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:dic_eliminar_descripcion();" name="frm_diceliminar_descripcion">

										<input type="text" name="ideliminar_dic_descripcion" value="'.$reg['ID_DAD'].'" hidden>
										<input class="btn btn-danger pulse-grow" type="submit" id="diceliminar_descripcion" value="Eliminar" data-toggle="tooltip" data-placement="top" title="Eliminar">
										<a class="btn btn-default curl-top-right" href="index" data-toggle="tooltip" data-placement="top" title="Regresar" value="Regresar">Cerrar</a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM dictamenes_manual WHERE ID_DM = '$_POST[ideliminarmanu]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									...
									<div class="alert alert-danger" role="alert" id="mos_dic_manual" hidden ></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:dic_eliminar_manual();" name="frm_oameliminar_manual" method="post" id="dic_eliminar_manual">

										<input type="text" name="ideliminarmanu" value="'.$reg['ID_DM'].'" hidden>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM dictamenes_tutorial WHERE ID_DTT = '$_POST[ideliminartuto]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									...
									<div class="alert alert-danger" role="alert" id="mos_dic_tutorial" hidden ></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:dic_eliminar_tutorial();" name="frm_faeliminar_tutorial" id="dic_eliminar_tutorial">

										<input type="text" name="ideliminartuto" value="'.$reg['ID_DTT'].'" hidden>
