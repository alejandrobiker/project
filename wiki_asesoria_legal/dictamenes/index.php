			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Dictamenes.php");						
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_dic");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_asesoria_legal/dictamenes/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_dic");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_asesoria_legal/dictamenes/index.php');
						</script>
