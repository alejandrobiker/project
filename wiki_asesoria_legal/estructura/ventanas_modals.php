		                        ...
		                        <div class="form-group">
                        			<div class="input-group">
                     				 	...
                     				 	<select style="height:40px" name="rol" class="form-control" required/>
                        					...
                        					<option value="Usuario Dictamenes">Usuario Dictámenes</option>
                        					<option value="Usuario Convenios">Usuario Convenios</option>
                        					<option value="Usuario Pronunciamientos">Usuario Pronunciamientos</option>
                        				</select>
                   				 	</div>
           					    </div>
