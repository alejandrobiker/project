	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Pronunciamientos.php");						
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Pronunciamientos </h2>
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_pro");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_asesoria_legal/pronunciamientos/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_pro");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_asesoria_legal/pronunciamientos/index.php');
						</script>
