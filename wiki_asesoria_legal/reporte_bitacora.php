...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Bitácora Asesoría Legal</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM bitacora WHERE TABLA LIKE 'dictamenes_articulo_d' OR TABLA LIKE 'dictamenes_articulo_t' OR TABLA LIKE 'dictamenes_manual' OR TABLA LIKE 'dictamenes_tutorial' OR TABLA LIKE 'convenios_articulo_t' OR TABLA LIKE 'convenios_articulo_d' OR TABLA LIKE 'convenios_manual' OR TABLA LIKE 'convenios_tutorial' OR TABLA LIKE 'pronunciamiento_articulo_t' OR TABLA LIKE 'pronunciamiento_articulo_d' OR TABLA LIKE 'pronunciamiento_manual' OR TABLA LIKE 'pronunciamiento_tutorial' ORDER BY ID_BITACORA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_bitacora_asesoria_legal.pdf");
