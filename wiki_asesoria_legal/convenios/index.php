			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Convenios.php");						
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<ul class="breadcrumb">
							...
							<li class="active">Artículo</li>							      
								...
								session_start();
				                	...
				                	if ($_SESSION['usercedula'] != null && $_SESSION['userrol'] == "Manager Asesoria Legal" || $_SESSION['userrol'] == "Usuario Convenios") {				      echo'
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_con");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_asesoria_legal/convenios/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_con");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_asesoria_legal/convenios/index.php');
						</script>
