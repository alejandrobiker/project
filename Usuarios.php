...
<html lang="es">
  	...
  	<head>
	  	<?php
	    	require_once'estructura/head.php';
  			include('utilidad/php/seguridad.php');  
	    ?>		
	    <!-- Buttons DataTables -->
  	...
  	<body>				
  		...
  		<?php
  			include('utilidad/php/usuarios/modales_modificar.php');
  			include('utilidad/php/usuarios/modales_eliminar.php');
		...
		<script>
			...
			var listar = function(){
				var table = $("#dt_usuario").DataTable({
					...
					"ajax":{
						"method":"POST",
						"url": "utilidad/php/usuarios/listar_usuarios.php"
					},
			...
			var obtener_id_eliminar = function(tbody, table){
				$(tbody).on("click", "button.eliminar", function(){
					...
					var CEDULA = $("#rol_ced").val(data.CEDULA);						
				});
			}
