...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Usuarios Área Técnica</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM usuarios_wiki WHERE ROL LIKE 'Usuario Servicio Certificacion' OR ROL LIKE 'Usuario Formacion' OR ROL LIKE 'Usuario Estandarizacion' OR ROL LIKE 'Usuario Area Tecnica' ORDER BY CEDULA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_usuarios_area_tecnica.pdf");
