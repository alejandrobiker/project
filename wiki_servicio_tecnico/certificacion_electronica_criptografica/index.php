	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Certificacion_Electronica_Criptografica.php");
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Certificación Electrónica Criptográfica </h2>
				...
				<!-- Contenido del link 10 columnas-->
					<div class="col-md-10">
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_cec");
						...
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_cec");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_servicio_tecnico/certificacion_electronica_criptografica/index.php');
						</script>
