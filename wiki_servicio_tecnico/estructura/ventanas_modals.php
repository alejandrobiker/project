		                        ...
		                        <div class="form-group">
                        			<div class="input-group">
                     				 	...
                     				 	<select style="height:40px" name="rol" class="form-control" required/>
                        					...
                        					<option value="Usuario Servicio Certificacion">Usuario Servicio de Certificación Electrónica y Criptográfica</option>
                        					<option value="Usuario Formacion">Usuario Investigación, Formación y Desarrollo</option>
                        					<option value="Usuario Estandarizacion">Usuario Estandarización y Fiscalización</option>
                        					<option value="Usuario Area Tecnica">Usuario Área Técnica</option>
                        				</select>
                   				 	</div>
           					    </div>
