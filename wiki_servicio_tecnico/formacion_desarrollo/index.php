	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Formacion_Desarrollo.php");						
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Investigación, Formación y Desarrollo </h2>
				...
				<!-- Contenido del link 10 columnas-->				
					<div class="col-md-10">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Artículo</li>							      
								...
								session_start();
						                	...
						                	if ($_SESSION['usercedula'] != null && $_SESSION['userrol'] == "Manager Area Tecnica" || $_SESSION['userrol'] == "Usuario Formacion") {							      echo'
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_fd");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_servicio_tecnico/formacion_desarrollo/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_fd");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_servicio_tecnico/formacion_desarrollo/index.php');
						</script>
