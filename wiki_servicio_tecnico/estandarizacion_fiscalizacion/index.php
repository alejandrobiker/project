	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Estandarizacion_Fiscalizacion.php");
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Estandarización Fiscalización </h2>
				...
				<div class="col-md-10">
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_ef");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_servicio_tecnico/estandarizacion_fiscalizacion/index.php');

						</script>

						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_ef");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_servicio_tecnico/estandarizacion_fiscalizacion/index.php');
						</script>
