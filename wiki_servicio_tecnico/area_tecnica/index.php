	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Soporte_Tecnico.php");
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Área Técnica </h2>
				...
				<!-- Contenido del link 10 columnas-->
					<div class="col-md-10">
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_st");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_servicio_tecnico/soporte_tecnico/index.php');

						</script>

						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_st");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_servicio_tecnico/soporte_tecnico/index.php');
						</script>
