...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Bitácora Área Técnica</div><br>
...
$dompdf->render();
$dompdf->stream("Wiki_bitacora_Area_Tecnica.pdf");
