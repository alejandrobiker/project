...
<body>
	        ...
	        <div class="modal-dialog">
	          	<div class="modal-content">
		            ...
		            <div class="modal-body">       
	     				...
	     				<form action="javascript:or_registrar();" name="frm_or_registrar" enctype="multipart/form-data" id="or_registrar">
		                        		                      
			                <div class="form-group">
		                        <div class="input-group">
		                        	<span class="input-group-addon">Título</span>
		                        	<input type="text" name="or_titulo" class="form-control" required onkeypress="return solomayuscula(event,this)">

		                        	<span class="input-group-addon">Tipo de Contenido</span>
								 	<select name="or_tipo" class="form-control" required/>
			                ...
			                <div class="form-group">
			                    <div class="input-group">
			                        ...
			                        <textarea name="or_descripcion" class="form-control" cols="60" rows="4" required onkeypress="return solomayuscula(event,this)"></textarea>
								</div>
		                    </div>
			                    <div class="alert alert-success" role="alert" id="mos_or" hidden></div>	          
	...
	<script type="text/javascript">
		...
		editorwiki = CKEDITOR.replace("or_descripcion");
		CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_planificacion_organizacion_presupuesto/organizacion/index.php')
		 //}
	</script>
	        ...
	        <div class="modal-dialog">
	          	<div class="modal-content">
		            ...
		            <div class="modal-body">       
	     				...
	     				<form action="javascript:or_manual();" name="frm_rwiki" enctype="multipart/form-data" id="or_manual">
		                        		                      
			                <div class="form-group">
		                        <div class="input-group">
		                        	<span class="input-group-addon">Título</span>
		                        	<input type="text" name="or_manual_titulo" class="form-control" required onkeypress="return solomayuscula(event,this)">

		                        	<span class="input-group-addon">Tipo de Contenido</span>
								 	<select name="or_manual_tipo" class="form-control" required/>
										<option value="publico">Público</option>
										<option value="privado">Privado</option>
									</select>
		                        </div>
			                ...
			                <div class="form-group">
			                	...
			                	<div id="agarrarimagen">
		                    		<input name="file_or_manual" class="file" type="file" id="files" accept="image/docx" multiple required  onchange="return documentos(this)"/>
	                 			</div>
	        ...
	        <div class="modal-dialog">
	          	<div class="modal-content">
		            ...
		            <div class="modal-body">       
	     				...
	     				<form action="javascript:or_tutorial();" name="frm_rwiki" enctype="multipart/form-data" id="or_tutoriales">
		                        		                      
			                <div class="form-group">
		                        <div class="input-group">
		                        	<span class="input-group-addon">Título</span>
		                        	<input type="text" name="or_tutorial_titulo" class="form-control" required onkeypress="return solomayuscula(event,this)">

		                        	<span class="input-group-addon">Tipo de Contenido</span>
								 	<select name="or_tutorial_tipo" class="form-control" required/>
										<option value="publico">Público</option>
										<option value="privado">Privado</option>
									</select>
		                        </div>
			                ...
			                <div class="form-group">
		                		...
		                		<div id="agarrarimagen">
	                    			<input name="file_or_tutorial" class="file" type="file" id="filestuto" accept="video/mp4" multiple required  onchange="return videos(this)"/>
	                 		 	</div>
								
								<!-- alertas -->
								<div class="alert alert-info" role="alert" align="center">Formatos permitidos: MP4 - WEBM <br> Tamaño máximo de video: 40 MB</div></div>
	                			...
	                			<div class="alert alert-success" role="alert" id="res_or_tutoriales" hidden></div>	                  
