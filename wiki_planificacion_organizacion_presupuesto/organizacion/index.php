	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Organizacion.php");						
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Organización </h2>
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_or");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_planificacion_organizacion_presupuesto/organizacion/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_or");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_planificacion_organizacion_presupuesto/organizacion/index.php');
						</script>
