...
<body>
   ...
   <img style="margin-top:-20px;" width="100%" src="../../utilidad/img/articulo.png">
      ...
      $seleccionartitu = mysql_query("SELECT * FROM oficina_presupuesto_articulo_t ",$con);
      ...
      $seleccionardesc = mysql_query("SELECT * FROM oficina_presupuesto_articulo_d WHERE '$sesiontitu[ID_OPAT]' = ID_TITULO_OPAT",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_presupuesto.pdf");
