		                        ...
		                        <div class="form-group">
                        			<div class="input-group">
                     				 	...
                     				 	<select style="height:40px" name="rol" class="form-control" required/>
                        					...
                        					<option value="Usuario Organizacion">Usuario Organizacion</option>
                        					<option value="Usuario Planificacion">Usuario Planificacion</option>
                        					<option value="Usuario Presupuesto">Usuario Presupuesto</option>
                        				</select>
                   				 	</div>
           					    </div>
