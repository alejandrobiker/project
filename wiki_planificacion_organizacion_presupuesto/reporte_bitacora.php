...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Bitácora Planificación, Organización y Presupuesto</div><br>
...
$dompdf->render();
$dompdf->stream("Wiki_bitacora_pop.pdf");
