...
class Planificacion extends Organizacion_Planificacion_Presupuesto
{
	...
	function Planificacion($titulo_,$tipo_)
	{
	...
	function Registrar_Titulo(){
		...
		include('../../../../utilidad/php/Conexion.php');
			...
			mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");
	      	...
	      	mysql_query("INSERT INTO oficina_planificacion_articulo_t (TITULO_OPAT,TIPO,UCEDULA) VALUES ('$this->titulo','$this->tipo','$_SESSION[usercedula]')",$con);
	...
	function Registrar_Descripcion(){
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
					mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");		
	mysql_query("INSERT INTO oficina_planificacion_articulo_d (ID_TITULO_OPAT,DESCRIPCION_OPAD,UCEDULA) VALUES ('$this->id','$this->descripcion','$_SESSION[usercedula]')",$con);
	...
	include('../../../../utilidad/php/Conexion.php');
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
			...
			mysql_query("UPDATE oficina_planificacion_articulo_t set TITULO_OPAT = '$this->descripcion', TIPO = '$this->tipo', UCEDULA = '$_SESSION[usercedula]' WHERE ID_OPAT = '$this->id'",$con);
	...
	function Modificar_Descripcion (){
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
			...
			mysql_query("UPDATE oficina_planificacion_articulo_d set DESCRIPCION_OPAD = '$this->descripcion', UCEDULA = '$_SESSION[usercedula]' WHERE ID_OPAD = '$this->id'",$con);
	...
	function Eliminar_Titulo(){
		...
		include('../../../../utilidad/php/Conexion.php');
			...
			mysql_query("DELETE FROM oficina_planificacion_articulo_t WHERE ID_OPAT = '$this->id'",$con);
	...
	function Eliminar_Descripcion(){
		...
		include('../../../../utilidad/php/Conexion.php');
			...
			mysql_query("DELETE FROM oficina_planificacion_articulo_d WHERE ID_OPAD = '$this->id'",$con);
	...
	function Mostrar_Titulos(){
		...
		$seleccionartitulo = new PHPPaging;
			...
			mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");
				...
				$seleccionartitulo -> mysql_query("SELECT * FROM oficina_planificacion_articulo_t",$con);					
				$seleccionartitulo ->ejecutar();
				while($sesion = $seleccionartitulo->mysql_fetch_array()){

					if ($sesion['TIPO'] != "privado" || $_SESSION['userrol'] == "Manager P O P" || $_SESSION['userrol'] == "Usuario Planificacion") {
					echo '
						<div >
							<ul class="menu">
	...
	function Mostrar(){
		...
		$seleccionar = new PHPPaging;
			...
			mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");
				...
				$seleccionar -> mysql_query("SELECT * FROM oficina_planificacion_articulo_t",$con);					
						...
						<div class="col-lg-12 text-center">
							...
							session_start();
								...
								<form action="index"  method="post" name="form" id="modificar">
									<input type="text" name="idmodificar_pl_titulo" value="'.$sesion['ID_OPAT'].'" hidden>
								...
								print '<form action="index"  method="post" name="form" id="eliminar">
									<input type="text" name="ideliminar_pl_titulo" value="'.$sesion['ID_OPAT'].'" hidden>
								...
								<form action="index"  method="post" name="form">
									<input type="text" name="registrar_contenido_pl" value="'.$sesion['ID_OPAT'].'" hidden>
				...
				$seleccdes = mysql_query("SELECT * FROM oficina_planificacion_articulo_d WHERE '$sesion[ID_OPAT]' = ID_TITULO_OPAT",$con);			
				...
				while($sesionwiki = mysql_fetch_array($seleccdes)){
					...
					if ($sesion['TIPO'] != "privado" || $_SESSION['userrol'] == "Manager P O P" || $_SESSION['userrol'] == "Usuario Planificacion") {
                    	...
                    	<p class="parrafo">'.$sesionwiki['DESCRIPCION_OPAD'].'</p>';
               			 ...
               			 session_start();
						        ...
						        if ($_SESSION['usercedula'] != null && $_SESSION['userrol'] == "Manager P O P" || $_SESSION['userrol'] == "Usuario Planificacion"){
									...
									<div style="color:#FF0000;">
										<form action="index"  method="post" name="form" id="modificar">
											<input type="text" name="idmodificar_pl_descripcion" value="'.$sesionwiki['ID_OPAD'].'" hidden>
										...
										<form action="index"  method="post" name="form" id="eliminar">
											<input type="text" name="ideliminar_pl_descripcion" value="'.$sesionwiki['ID_OPAD'].'" hidden>
											<button class="botones" type="submit" data-toggle="tooltip" data-placement="top" title="Eliminar" value="Eliminar" >[ <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> ]													
											</button>
										</form>
									</div>	';
	...
	function Registrar_Manual(){
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
					mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");		
	mysql_query("INSERT INTO oficina_planificacion_manual (TITULO_OPM,TIPO,DOCUMENTO,UCEDULA) VALUES ('$this->titulo','$this->valor','$this->imagen','$_SESSION[usercedula]')",$con);
	...
	function Modificar_Manual(){
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
			...
			mysql_query("UPDATE oficina_planificacion_manual set TITULO_OPM = '$this->descripcion', TIPO = '$this->tipo', UCEDULA = '$_SESSION[usercedula]' WHERE ID_OPM = '$this->id'",$con);
...
mysql_query("UPDATE oficina_planificacion_manual set DOCUMENTO = '$this->imagen', UCEDULA = '$_SESSION[usercedula]' WHERE ID_OPM = '$this->id'",$con);
...
function Eliminar_Manual(){
		include('../../../../utilidad/php/Conexion.php');
			...
			mysql_query("DELETE FROM oficina_planificacion_manual WHERE ID_OPM = '$this->id'",$con);
	}
	...
	function Registrar_Tutorial(){
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
					mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");		
	mysql_query("INSERT INTO oficina_planificacion_tutorial (TITULO_OPTT,TIPO,VIDEO,UCEDULA) VALUES ('$this->titulo','$this->valor','$this->imagen','$_SESSION[usercedula]')",$con);
	...
	function Modificar_Tutorial(){
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
			...
			mysql_query("UPDATE oficina_planificacion_tutorial set TITULO_OPTT = '$this->descripcion', TIPO = '$this->tipo', UCEDULA = '$_SESSION[usercedula]' WHERE ID_OPTT = '$this->id'",$con);
	}
		...
		$con = mysql_connect($host,$user,$pw)or die("Problemas al Conectar");
			...
			mysql_query("UPDATE oficina_planificacion_tutorial set VIDEO = '$this->imagen', UCEDULA = '$_SESSION[usercedula]' WHERE ID_OPTT = '$this->id'",$con);
	}
	...
	function Eliminar_Tutorial(){
		include('../../../../utilidad/php/Conexion.php');
			...
			mysql_query("DELETE FROM oficina_planificacion_tutorial WHERE ID_OPTT = '$this->id'",$con);
	}
	...
	function Mostrar_Manual_Titu(){
		...
		include('../../utilidad/php/Conexion.php');
			...
			mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");
				...
				$seleccionar = mysql_query("SELECT * FROM oficina_planificacion_manual",$con);					
	...
	function Mostrar_Tutorial_Titu(){
		...
		include('../../utilidad/php/Conexion.php');
			...
			mysql_select_db($db,$con)or die("Problemas al Conectar con la Base de Datos");
				...
				$seleccionar = mysql_query("SELECT * FROM oficina_planificacion_tutorial",$con);					
				while($sesion = mysql_fetch_array($seleccionar)){
