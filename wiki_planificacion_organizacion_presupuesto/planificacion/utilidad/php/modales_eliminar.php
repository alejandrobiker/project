...
ini_set('display_errors', 0); // no muestra los errores
	...
	if(isset($_POST['ideliminar_pl_titulo']) && !empty($_POST['ideliminar_pl_titulo'])){
				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM oficina_planificacion_articulo_t WHERE ID_OPAT = '$_POST[ideliminar_pl_titulo]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									...
									<div class="alert alert-danger" role="alert" id="mos_pl_titulo" hidden></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:pl_eliminar_titulo();" name="frm_pleliminar_titulo">

										<input type="text" name="ideliminar_pl_titulo" value="'.$reg['ID_OPAT'].'" hidden>
										<input class="btn btn-danger pulse-grow" type="submit" id="pleliminar_titulo" value="Eliminar" data-toggle="tooltip" data-placement="top" title="Eliminar">
	...
	}elseif(isset($_POST['ideliminar_pl_descripcion']) && !empty($_POST['ideliminar_pl_descripcion'])){
				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM oficina_planificacion_articulo_d WHERE ID_OPAD = '$_POST[ideliminar_pl_descripcion]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									...
									<div class="alert alert-danger" role="alert" id="mos_pl_descripcion" hidden></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:pl_eliminar_descripcion();" name="frm_pleliminar_descripcion">

										<input type="text" name="ideliminar_pl_descripcion" value="'.$reg['ID_OPAD'].'" hidden>
										<input class="btn btn-danger pulse-grow" type="submit" id="pleliminar_descripcion" value="Eliminar" data-toggle="tooltip" data-placement="top" title="Eliminar">
										<a class="btn btn-default curl-top-right" href="index" data-toggle="tooltip" data-placement="top" title="Regresar" value="Regresar">Cerrar</a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM oficina_planificacion_manual WHERE ID_OPM = '$_POST[ideliminarmanu]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									...
									<div class="alert alert-danger" role="alert" id="mos_pl_manual" hidden ></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:pl_eliminar_manual();" name="frm_oameliminar_manual" method="post" id="pl_eliminar_manual">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						';
							...
							$regis = mysql_query("SELECT * FROM oficina_planificacion_tutorial WHERE ID_OPTT = '$_POST[ideliminartuto]'",$con);
							...
							if($reg = mysql_fetch_array($regis)){
								...
								<div class="modal-body">
									...
									<div class="alert alert-danger" role="alert" id="mos_pl_tutorial" hidden ></div>
								...
								<div class="modal-footer">	
									...
									<form action="javascript:pl_eliminar_tutorial();" name="frm_faeliminar_tutorial" id="pl_eliminar_tutorial">
