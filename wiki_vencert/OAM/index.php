			...
			<div class="row">
				...
				<!-- Contenido del link 10 columnas-->				
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_oam");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_vencert/oam/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_oam");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_vencert/oam/index.php');
						</script>
