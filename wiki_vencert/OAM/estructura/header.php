         				 ...
         				 <?php 
         				 	session_start(); 
         				 		...
         				 		echo'
				 					...
				 					echo'<button class="btn btn-primary sesion dropdown-toggle" type="button" data-toggle="dropdown"> '.$_SESSION['usernombre'].' '.$_SESSION['userapellido'].'  '.'<span class="caret"></span></button>

			                      	<ul class="dropdown-menu dropdown-menu-right">
			                      		<li><a href=""><span class="glyphicon glyphicon-sunglasses"></span> Rol: '.$_SESSION['userrol'].'</a></li>
			                      		<li class="divider"></li>
				                      	<!--<li><a href="" data-toggle="modal"><span class="glyphicon glyphicon-wrench"></span> Cambiar Clave</a></li> 
				                        <li class="divider"></li>-->
