			...
			<div class="row">
				...
				<!-- Fin del logo -->
						...
						<script type="text/javascript">
							editorwiki = CKEDITOR.replace("contenido_sl");
							CKFinder.setupCKEditor(editorwiki, 'http://localhost/wiki/wiki_vencert/seguridad_logica/index.php');
							 
						</script>
						
						<script type="text/javascript">
							 editorcontenido = CKEDITOR.replace("descripcion_sl");
							 CKFinder.setupCKEditor(editorcontenido, 'http://localhost/wiki/wiki_vencert/seguridad_logica/index.php');
						</script>
