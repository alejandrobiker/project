					...
					<section class="menu menu_fixed">
						<div class="list-group">					
							...
							<header>
								...
								<nav>
									<ul class="menu">
										<li class="letra_efecto"><a href="index"><span class="glyphicon glyphicon-triangle-left" aria-hidden="true"></span> Regresar</a></li><br>
										<li class="letra_admin_efecto">Bitácora</li>
									<hr>							
									</ul>					
								</nav>
							</header>
