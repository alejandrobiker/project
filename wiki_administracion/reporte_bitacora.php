...
<body>
  <div>
    ...
    <div border="1" align="center" style="font-size:20px; font-family:Open Sans;">Bitácora Administración</div><br>
    ...
    <table width="95%" border="1" style="padding:2px;">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM bitacora WHERE TABLA LIKE 'procesos_administrativo_articulo_t' OR TABLA LIKE 'procesos_administrativo_articulo_d' OR TABLA LIKE 'procesos_administrativo_manual' OR TABLA LIKE 'procesos_administrativo_tutorial' ORDER BY ID_BITACORA asc",$con);
...
$dompdf->render();
$dompdf->stream("Wiki_bitacora_administracion.pdf");
