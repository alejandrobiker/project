	    ...
	    <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<?php
				      require_once'estructura/menu_principal.php';
						...
						include("utilidad/php/Proceso_Administrativo.php");
				...
				<div class="col-md-10" align="center">
					<h2 class="unidad">Proceso Administrativo</h2>
